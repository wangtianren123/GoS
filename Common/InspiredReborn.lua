...
OnLoop(function(myHero)
    if Ignite and InspiredConfigIgnite.getValue() then AutoIgnite() end
end)
...
if Ignite then
  InspiredConfig = menu.addItem(SubMenu.new("Inspired Reborn :')"))
  InspiredConfigIgnite =  InspiredConfig.addItem(MenuBool.new("Auto Ignite By Plebsu",true))
end
