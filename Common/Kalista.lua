...
OnLoop(function(myHero)
	...
	--pos1
	if HeroPos.x == 2894 and HeroPos.y == 95.748046875 and HeroPos.z == 4648 and WallJump.getValue() then
	...
	--pos1 Inverse
	if HeroPos.x == 2924 and HeroPos.y == 53.499828338623 and HeroPos.z == 4958 and WallJump.getValue() then
	...
	--pos2
	if HeroPos.x == 2474 and HeroPos.y == 93.368385314941 and HeroPos.z == 4708 and WallJump.getValue() then
	...
	--pos2 Inverse
	if HeroPos.x == 2524 and HeroPos.y == 52.793956756592 and HeroPos.z == 5008 and WallJump.getValue() then
	...
	--pos3
	if HeroPos.x == 4630 and HeroPos.y == 95.707084655762 and HeroPos.z == 3020 and WallJump.getValue() then
	...
	--pos3 Inverse
	if HeroPos.x == 4924 and HeroPos.y == 51.007656097412 and HeroPos.z == 3058 and WallJump.getValue() then
	...
	--pos4
	if HeroPos.x == 4674 and HeroPos.y == 96.089622497559 and HeroPos.z == 2608 and WallJump.getValue() then
	...
	--pos4 Inverse
	if HeroPos.x == 4974 and HeroPos.y == 52.284427642822 and HeroPos.z == 2658 and WallJump.getValue() then
	...
	--pos5
	if HeroPos.x == 8222 and HeroPos.y == 51.648384094238 and HeroPos.z == 3158 and WallJump.getValue() then
	...
	--pos5 Inverse
	if HeroPos.x == 8260 and HeroPos.y == 51.130001068115 and HeroPos.z == 2890 and WallJump.getValue() then
	...
	--pos6
	if HeroPos.x == 9630 and HeroPos.y == 49.2229227093506 and HeroPos.z == 2794 and WallJump.getValue() then
	...
	--pos6 Inverse
	if HeroPos.x == 9654 and HeroPos.y == 63.591632843018 and HeroPos.z == 3052 and WallJump.getValue() then
	...
	--pos7
	if HeroPos.x == 6126 and HeroPos.y == 48.527687072754 and HeroPos.z == 5304 and WallJump.getValue() then
	...
	--pos7 Inverse
	if HeroPos.x == 6090 and HeroPos.y == 51.77721786499 and HeroPos.z == 5572 and WallJump.getValue() then
	...
	--pos8
	if HeroPos.x == 7194 and HeroPos.y == 58.672454833984 and HeroPos.z == 5630 and WallJump.getValue() then
	...
	--pos8 Inverse
	if HeroPos.x == 7372 and HeroPos.y == 52.565311431885 and HeroPos.z == 5858 and WallJump.getValue() then
	...
	--pos9
	if HeroPos.x == 7572 and HeroPos.y == 52.451301574707 and HeroPos.z == 6158 and WallJump.getValue() then
	...
	--pos9 Inverse
	if HeroPos.x == 7772 and HeroPos.y == -49.371105194092 and HeroPos.z == 6308 and WallJump.getValue() then
	...
	--pos10
	if HeroPos.x == 7972 and HeroPos.y == 50.290023803711 and HeroPos.z == 5908 and WallJump.getValue() then
	...
	--pos10 Inverse
	if HeroPos.x == 8204 and HeroPos.y == -71.240600585938 and HeroPos.z == 6080 and WallJump.getValue() then
	...
	--pos11
	if HeroPos.x == 9022 and HeroPos.y == 52.721687316895 and HeroPos.z == 4408 and WallJump.getValue() then
	...
	--pos11 Inverse
	if HeroPos.x == 9314 and HeroPos.y == -71.240600585938 and HeroPos.z == 4518 and WallJump.getValue() then
	...
	--pos12
	if HeroPos.x == 9722 and HeroPos.y == -71.240600585938 and HeroPos.z == 4908 and WallJump.getValue() then
	...
	--pos12 Inverse
	if HeroPos.x == 9700 and HeroPos.y == -72.525970458984 and HeroPos.z == 5198 and WallJump.getValue() then
	...
	--pos13
	if HeroPos.x == 10462 and HeroPos.y == -71.240600585938 and HeroPos.z == 4352 and WallJump.getValue() then
	...
	--pos13 Inverse
	if HeroPos.x == 10694 and HeroPos.y == -70.244300842285 and HeroPos.z == 4526 and WallJump.getValue() then
	...
	--pos14
	if HeroPos.x == 11872 and HeroPos.y == -71.240600585938 and HeroPos.z == 4358 and WallJump.getValue() then
	...
	--pos14 Inverse
	if HeroPos.x == 12072 and HeroPos.y == 51.729400634766 and HeroPos.z == 4608 and WallJump.getValue() then
	...
	--pos15
	if HeroPos.x == 11772 and HeroPos.y == -71.240600585938 and HeroPos.z == 4608 and WallJump.getValue() then
	...
	--pos15 Inverse
	if HeroPos.x == 11922 and HeroPos.y == 51.729400634766 and HeroPos.z == 4758 and WallJump.getValue() then
	...
	--pos16
	if HeroPos.x == 11556 and HeroPos.y == -71.240600585938 and HeroPos.z == 4870 and WallJump.getValue() then
	...
	--pos16 Inverse
	if HeroPos.x == 11722 and HeroPos.y == 51.783386230469 and HeroPos.z == 5024 and WallJump.getValue() then
	...
	--pos17
	if HeroPos.x == 11342 and HeroPos.y == -61.051364898682 and HeroPos.z == 5274 and WallJump.getValue() then
	...
	--pos17 Inverse
	if HeroPos.x == 11592 and HeroPos.y == 52.870578765896 and HeroPos.z == 5316 and WallJump.getValue() then
	...
	--pos18
	if HeroPos.x == 12034 and HeroPos.y == 54.640922546387 and HeroPos.z == 5420 and WallJump.getValue() then
	...
	--pos18 Inverse
	if HeroPos.x == 12272 and HeroPos.y == 51.729400634766 and HeroPos.z == 5408 and WallJump.getValue() then
	...
	--pos19
	if HeroPos.x == 11966 and HeroPos.y == 53.515453338623 and HeroPos.z == 5592 and WallJump.getValue() then
	CastSkillShot(_Q,12272, 51.729400634766, 5408)  
    MoveToXYZ(12272, 51.729400634766, 5408)
	...
	--pos20
	if HeroPos.x == 11372 and HeroPos.y == 51.72611618042 and HeroPos.z == 7208 and WallJump.getValue() then
	...
	--pos20 Inverse
	if HeroPos.x == 11338 and HeroPos.y == 52.204162597656 and HeroPos.z == 7496 and WallJump.getValue() then
    ...
    --pos21
	if HeroPos.x == 10772 and HeroPos.y == 51.722599029541 and HeroPos.z == 7208 and WallJump.getValue() then
	...
	--pos21 Inverse
	if HeroPos.x == 10738 and HeroPos.y == 52.030101776123 and HeroPos.z == 7450 and WallJump.getValue() then
	...
	--pos22
	if HeroPos.x == 10432 and HeroPos.y == 51.977336883545 and HeroPos.z == 6768 and WallJump.getValue() then
	...
	--pos22 Inverse
	if HeroPos.x == 10712 and HeroPos.y == 51.722599029541 and HeroPos.z == 6906 and WallJump.getValue() then
	...
	--pos23
	if HeroPos.x == 12072 and HeroPos.y == 52.360904693604 and HeroPos.z == 8156 and WallJump.getValue() then
	...
	--pos23 Inverse
	if HeroPos.x == 11772 and HeroPos.y == 54.545017242432 and HeroPos.z == 8206 and WallJump.getValue() then
	...
	--pos24
	if HeroPos.x == 11768 and HeroPos.y == 50.307735443115 and HeroPos.z == 8904 and WallJump.getValue() then
	...
	--pos24 Inverse
	if HeroPos.x == 11572 and HeroPos.y == 64.131408691406 and HeroPos.z == 8706 and WallJump.getValue() then
	...
	--pos25
	if HeroPos.x == 12272 and HeroPos.y == 56.769378662109 and HeroPos.z == 9956 and WallJump.getValue() then
	...
	--pos25 Inverse
	if HeroPos.x == 12372 and HeroPos.y == 91.429809570313 and HeroPos.z == 10256 and WallJump.getValue() then
...
DrawCircle(pos21,80,1,0,0xffffffff)
DrawCircle(zoudjpos21,80,1,0,0xffffffff)
DrawCircle(pos22,80,1,0,0xffffffff)
DrawCircle(zoudjpos22,80,1,0,0xffffffff)
DrawCircle(pos23,80,1,0,0xffffffff)
DrawCircle(zoudjpos23,80,1,0,0xffffffff)
DrawCircle(pos24,80,1,0,0xffffffff)
DrawCircle(zoudjpos24,80,1,0,0xffffffff)
DrawCircle(pos25,80,1,0,0xffffffff)
DrawCircle(zoudjpos25,80,1,0,0xffffffff)
end
