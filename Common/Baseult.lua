PrintChat("Baseult 4.0 By Deftsu Loaded / Credits : Inspired <3 and Feretorix for this awesome tool #RIPLaiha")
...
elseif GetObjectName(myHero) == "Jinx" then
	delay = 600
	missileSpeed = (GetDistance(enemyBasePos) / (1 + (GetDistance(enemyBasePos)-1500)/2500)) -- Credits to Noddy
