...
OnLoop(function(myHero)
	...
	for i,enemy in pairs(GoS:GetEnemyHeroes()) do
		...
		if Ignite and CassiopeiaMenu.Misc.AutoIgnite:Value() then
                  if CanUseSpell(myHero, Ignite) == READY and GoS:ValidTarget(enemy, 600) and 20*GetLevel(myHero)+50 > GetCurrentHP(enemy)+GetHPRegen(enemy)*2.5 and GoS:ValidTarget(enemy, 900) then
