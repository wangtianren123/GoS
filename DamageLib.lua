...
function getdmg(spellname,target,myHero,stagedmg,spelllvl)
	...
	elseif spellname == "Q" or spellname == "W" or spellname == "E" or spellname == "R" or spellname == "P" or spellname == "QM" or spellname == "WM" or spellname == "EM" then
		...
		if GetObjectName(myHero) == "Aatrox" then
			...
			elseif spellname == "W" then addmg = (35*Wlvl(myHero)+25+(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*(stagedmg1+stagedmg3) Typedmg = 2
		...
		elseif GetObjectName(myHero) == "Ahri" then
			if spellname == "Q" then apdmg = (25*Qlvl(myHero)+15+.35*GetBonusAP(myHero))*(stagedmg1+stagedmg3) dmg = + (25*Qlvl(myHero)+15+.35*GetBonusAP(myHero))*(stagedmg2+stagedmg3) -- stage1:Initial. stage2:way back. stage3:total.
			elseif spellname == "W" then apdmg = math.max(25*Wlvl(myHero)+15+.4*GetBonusAP(myHero),(25*Wlvl(myHero)+15+.4*GetBonusAP(myHero))*1.6*stagedmg3) -- xfox-fires ,  30% damage from each additional fox-fire beyond the first. stage3: Max damage
		...
		elseif GetObjectName(myHero) == "Ashe" then  -- script doesn't calculate autos and therefore doesn't take Ashe's crit mechanic on slowed targets into effect
			if spellname == "Q" then addmg = (.05*Qlvl(myHero)+.1)*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 --xhit (bonus)
		...
		elseif GetObjectName(myHero) == "Blitzcrank" then
			...
			elseif spellname == "E" then addmg = (GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2
		...
		elseif GetObjectName(myHero) == "Brand" then
			...
			elseif spellname == "W" then apdmg = math.max(45*Wlvl(myHero)+30+.6*GetBonusAP(myHero),(45*Wlvl(myHero)+30+.6*GetBonusAP(myHero))*1.25*stagedmg3) --125% for units that are ablaze. stage3: Max damage
		...
		elseif GetObjectName(myHero) == "Caitlyn" then
			if spellname == "P" then addmg = .5*(GetBonusdmg(myHero)+GetBaseDamage(myHero))*1.5 Typedmg = 2 --xheadshot (bonus)
		...
		elseif GetObjectName(myHero) == "Chogath" then
			...
			elseif spellname == "E" then apdmg = 15*Elvl(myHero)+5+.3*GetBonusAP(myHero) Typedmg = 2 --xhit (bonus)
			elseif spellname == "R" then dmg = + 175*Rlvl(myHero)+125+.7*GetBonusAP(myHero)
			end
		elseif GetObjectName(myHero) == "Corki" then
			if spellname == "P" then dmg = + .1*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 --xhit (bonus)
		...
		elseif GetObjectName(myHero) == "Darius" then
			...
			elseif spellname == "W" then addmg = .2*Wlvl(myHero)*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 --(bonus)
			elseif spellname == "R" then dmg = + math.max(90*Rlvl(myHero)+70+.75*(GetBonusdmg(myHero)+GetBaseDamage(myHero)),(90*Rlvl(myHero)+70+.75*(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*2*stagedmg3) --xstack of Hemorrhage deals an additional 20% damage. stage3: Max damage
			end
		elseif GetObjectName(myHero) == "Diana" then
			if spellname == "P" then apdmg = math.max(5*GetLevel(myHero)+15,10*GetLevel(myHero)-10,15*GetLevel(myHero)-60,20*GetLevel(myHero)-125,25*GetLevel(myHero)-200)+.8*GetBonusAP(myHero) Typedmg = 2 -- (bonus)
		...
		elseif GetObjectName(myHero) == "Draven" then
			if spellname == "Q" then addmg = (.1*Qlvl(myHero)+.35)*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 --xhit (bonus)
		...
		elseif GetObjectName(myHero) == "Elise" then
			...
			elseif spellname == "Q" then apdmg = 35*Qlvl(myHero)+5+(4+.03*GetBonusAP(myHero))*GetCurrentHP(target)/100
			...
			elseif spellname == "R" then apdmg = 10*Rlvl(myHero)+.3*GetBonusAP(myHero) Typedmg = 2 --xhit (bonus)
			end
		elseif GetObjectName(myHero) == "Evelynn" then
			if spellname == "Q" then apdmg = 10*Qlvl(myHero)+30+(.05*Qlvl(myHero)+.3)*GetBonusAP(myHero)+(.05*Qlvl(myHero)+.45)*(GetBonusdmg(myHero)+GetBaseDamage(myHero))
		...
		elseif GetObjectName(myHero) == "Ezreal" then
			if spellname == "Q" then addmg = 20*Qlvl(myHero)+15+.4*GetBonusAP(myHero)+.1*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 -- (bonus)
		...
		elseif GetObjectName(myHero) == "Fiora" then
			if spellname == "Q" then addmg = 10*Qlvl(myHero)+55+((15*Qlvl+40)*GetBonusdmg(myHero))/100
			elseif spellname == "W" then apdmg = 40*Wlvl(myHero)+50+GetBonusAP(myHero)
			end
		elseif GetObjectName(myHero) == "Fizz" then
			if spellname == "Q" then apdmg = 15*Qlvl(myHero)-5+.3*GetBonusAP(myHero) Typedmg = 2 -- (bonus)
		...
		elseif GetObjectName(myHero) == "Galio" then
			...
			elseif spellname == "R" then apdmg = math.max(100*Rlvl(myHero)+100+.6*GetBonusAP(myHero),(100*Rlvl(myHero)+100+.6*GetBonusAP(myHero))*1.8*stagedmg3) --additional 5% damage for each attack suffered while channeling and capping at 40%. stage3: Max damage
			end
		elseif GetObjectName(myHero) == "Gangplank" then
			if spellname == "P" then addmg = 10+GetLevel(myHero)+20+1.2*GetBonusdmg(myHero) Typedmg = 2 --xstack
			elseif spellname == "Q" then addmg = 25*Qlvl(myHero)-5 (GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 --without counting on-hit effects
			elseif spellname == "R" then apdmg = 20*Rlvl(myHero)+30+.1*GetBonusAP(myHero) --xSec (7 sec)
			end
		elseif GetObjectName(myHero) == "Garen" then
			if spellname == "Q" then addmg = 25*Qlvl(myHero)+5+.4*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 -- (bonus)
		...
		elseif GetObjectName(myHero) == "Gragas" then
			...
			elseif spellname == "W" then apdmg = 30*Wlvl(myHero)-10+.3*GetBonusAP(myHero)+(.01*Wlvl(myHero)+.07)*GetMaxHP(target) Typedmg = 2 -- (bonus)
		...
		elseif GetObjectName(myHero) == "Heimerdinger" then
			if spellname == "Q" then apdmg = math.max((5.5*Qlvl(myHero)+6.5+.15*GetBonusAP(myHero))*stagedmg1,(math.max(20*Qlvl(myHero)+20,25*Qlvl(myHero)+5)+.55*GetBonusAP(myHero))*stagedmg2,(60*Rlvl(myHero)+120+.7*GetBonusAP(myHero))*stagedmg3) --stage1:x Turrets attack. stage2:Beam. stage3:UPGRADE Beam
		...
		elseif GetObjectName(myHero) == "Irelia" then
			if spellname == "Q" then addmg = 30*Qlvl(myHero)-10 Typedmg = 2 -- (bonus)
			elseif spellname == "W" then dmg = + 15*Wlvl(myHero) Typedmg = 2 --xhit (bonus)
		...
		elseif GetObjectName(myHero) == "Jax" then
			...
			elseif spellname == "W" then apdmg = 35*Wlvl(myHero)+5+.6*GetBonusAP(myHero) Typedmg = 2
			...
			elseif spellname == "R" then apdmg = 60*Rlvl(myHero)+40+.7*GetBonusAP(myHero) Typedmg = 2 --every third basic attack (bonus)
			end
		elseif GetObjectName(myHero) == "Jayce" then
			...
			elseif spellname == "W" then dmg = + 8*Wlvl(myHero)+62 --% damage
			...
			elseif spellname == "R" then apdmg = 40*Rlvl(myHero)-20 Typedmg = 2
			end
		elseif GetObjectName(myHero) == "Jinx" then
			if spellname == "Q" then addmg = .1*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2
		...
		elseif GetObjectName(myHero) == "Kassadin" then
			...
			elseif spellname == "W" then apdmg = math.max((25*Wlvl(myHero)+15+.6*GetBonusAP(myHero))*(stagedmg1+stagedmg3),(20+.1*GetBonusAP(myHero))*stagedmg2) Typedmg = 2 -- stage1-3:Active. stage2: Pasive.
			elseif spellname == "E" then apdmg = 25*Elvl(myHero)+55+.7*GetBonusAP(myHero)
			elseif spellname == "R" then apdmg = math.max((20*Rlvl(myHero)+60+.2*GetBonusAP(myHero)+.02*GetMaxMana(myHero))*(stagedmg1+stagedmg3),(10*Rlvl(myHero)+30+.1*GetBonusAP(myHero)+.01*GetMaxMana(myHero))*stagedmg2) --stage1-3:Initial. stage2:additional xstack (4 stack).
			end
		...
		elseif GetObjectName(myHero) == "Kayle" then
			...
			elseif spellname == "E" then apdmg = 10*Elvl(myHero)+10+.25*GetBonusAP(myHero) Typedmg = 2 --xhit (bonus)
			end
		...
		elseif GetObjectName(myHero) == "Khazix" then
			if spellname == "P" then apdmg = math.max(5*GetLevel(myHero)+10,10*GetLevel(myHero)-5,15*GetLevel(myHero)-55)-math.max(0,5*(GetLevel(myHero)-13))+.5*GetBonusAP(myHero) Typedmg = 2 -- (bonus)
		...
		elseif GetObjectName(myHero) == "KogMaw" then
			if spellname == "P" then dmg = + 100+25*GetLevel(myHero)
			elseif spellname == "Q" then apdmg = 50*Qlvl(myHero)+30+.5*GetBonusAP(myHero)
			elseif spellname == "W" then apdmg = (Wlvl(myHero)+1+.01*GetBonusAP(myHero))*GetMaxHP(target)/100 Typedmg = 2 --xhit (bonus)
		...
		elseif GetObjectName(myHero) == "Leblanc" then
			if spellname == "Q" then apdmg = math.max(25*Qlvl(myHero)+30+.4*GetBonusAP(myHero),(25*Qlvl(myHero)+30+.4*GetBonusAP(myHero))*2*stagedmg3) --Initial or mark. stage3: Max damage
			...
			elseif spellname == "R" then apdmg = math.max((100*Rlvl(myHero)+.6*GetBonusAP(myHero))*stagedmg1,(150*Rlvl(myHero)+.9*GetBonusAP(myHero))*stagedmg2,(100*Rlvl(myHero)+.6*GetBonusAP(myHero))*stagedmg3) --stage1:Q Initial or mark. stage2:W. stage3:E Initial or Delayed
			end
		elseif GetObjectName(myHero) == "LeeSin" then
			...
			elseif spellname == "R" then addmg = 200*Rlvl(myHero)+2*(GetBonusdmg(myHero)+GetBaseDamage(myHero))*stagedmg1,(200*Rlvl(myHero)+2*(GetBonusdmg(myHero)+GetBaseDamage(myHero))+(+3*GetCastLevel(myHero,_R)+12)*GetMaxHP(target)/100)
			end
		elseif GetObjectName(myHero) == "Leona" then
			if spellname == "P" then apdmg = (-1.25)*(3*(-1)^GetLevel(myHero)-6*GetLevel(myHero)-7)
			elseif spellname == "Q" then apdmg = 30*Qlvl(myHero)+10+.3*GetBonusAP(myHero) Typedmg = 2 -- (bonus)
		...
		elseif GetObjectName(myHero) == "Lucian" then
			if spellname == "P" then addmg = (.3+.1*math.floor((GetLevel(myHero)-1)/5))*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2
		...
		elseif GetObjectName(myHero) == "MasterYi" then
			if spellname == "P" then addmg = .5*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2
			...
			elseif spellname == "E" then dmg =  + 5*Elvl(myHero)+5+((5/2)*Elvl(myHero)+15/2)*(GetBonusdmg(myHero)+GetBaseDamage(myHero))/100
			end
		...
		elseif GetObjectName(myHero) == "Nami" then
			...
			elseif spellname == "E" then apdmg = 15*Elvl(myHero)+10+.2*GetBonusAP(myHero) Typedmg = 2 --xhit (max 3 hits)
			elseif spellname == "R" then apdmg = 100*Rlvl(myHero)+50+.6*GetBonusAP(myHero)
			end
		elseif GetObjectName(myHero) == "Nasus" then
			if spellname == "Q" then addmg = 20*Qlvl(myHero)+10 Typedmg = 2 --+3 per enemy killed by Siphoning Strike (bonus)
		...
		elseif GetObjectName(myHero) == "Nautilus" then
			if spellname == "P" then addmg = 2+6*GetLevel(myHero) Typedmg = 2
			elseif spellname == "Q" then apdmg = 45*Qlvl(myHero)+15+.75*GetBonusAP(myHero)
			elseif spellname == "W" then apdmg = 10*Wlvl(myHero)+20+.4*GetBonusAP(myHero) Typedmg = 2 --xhit (bonus)
			elseif spellname == "E" then apdmg = math.max(35*Elvl(myHero)+25+.5*GetBonusAP(myHero),(35*Elvl(myHero)+25+.5*GetBonusAP(myHero))*2*stagedmg3) --xexplosions , 50% less damage from additional explosions. stage3: Max damage
			elseif spellname == "R" then apdmg = 125*Rlvl(myHero)+75+.8*GetBonusAP(myHero)
			end
		elseif GetObjectName(myHero) == "Nidalee" then
			if spellname == "Q" then apdmg = 20*Qlvl(myHero)+30+.4*GetBonusAP(myHero) --deals 300% damage the further away the target is, gains damage from 525 units until 1300 units
		...
		elseif GetObjectName(myHero) == "Nocturne" then
			if spellname == "P" then addmg = .2*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 --(bonus)
		...
		elseif GetObjectName(myHero) == "Quinn" then
			if spellname == "P" then addmg = math.max(10*GetLevel(myHero)+15,15*GetLevel(myHero)-55)+.5*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 --(bonus)
		...
		elseif GetObjectName(myHero) == "Rammus" then
			...
			elseif spellname == "W" then apdmg = 10*Wlvl(myHero)+15+.1*GetArmor(myHero) --x each attack suffered
			elseif spellname == "R" then apdmg = 65*Rlvl(myHero)+.3*GetBonusAP(myHero) --xsec (8 sec)
			end
		elseif GetObjectName(myHero) == "RekSai" then
			if spellname == "Q" then addmg = 10*Qlvl(myHero)+5+.2*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 --(bonus)
			...
			elseif spellname == "E" then addmg = (.1*Elvl(myHero)+.7)*(GetBonusdmg(myHero)+GetBaseDamage(myHero))*(1+GetCurrentMana(myHero)/GetMaxMana(myHero))*(1-math.floor(GetCurrentMana(myHero)/GetMaxMana(myHero))) dmg = dmg + (.1*Elvl(myHero)+.7)*(GetBonusdmg(myHero)+GetBaseDamage(myHero))*2*math.floor(GetCurrentMana(myHero)/GetMaxMana(myHero))
			end
		elseif GetObjectName(myHero) == "Renekton" then
			if spellname == "Q" then addmg = math.max(30*Qlvl(myHero)+30+.8*(GetBonusdmg(myHero)+GetBaseDamage(myHero)),(30*Qlvl(myHero)+30+.8*(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*1.5*stagedmg3) --stage1:with 50 fury deals 50% additional damage. stage3: Max damage
			elseif spellname == "W" then addmg = math.max(20*Wlvl(myHero)-10+1.5*(GetBonusdmg(myHero)+GetBaseDamage(myHero)),(20*Wlvl(myHero)-10+1.5*(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*1.5*stagedmg3) --stage1:with 50 fury deals 50% additional damage. stage3: Max damage -- on hit x2 or x3
			elseif spellname == "E" then addmg = math.max(30*Elvl(myHero)+.9*(GetBonusdmg(myHero)+GetBaseDamage(myHero)),(30*Elvl(myHero)+.9*(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*1.5*stagedmg3) --stage1:Slice or Dice , with 50 fury Dice deals 50% additional damage. stage3: Max damage of Dice
		...
		elseif GetObjectName(myHero) == "Rengar" then
			if spellname == "Q" then addmg = math.max((30*Qlvl(myHero)+(.05*Qlvl(myHero)-.05)*(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*stagedmg1,(math.min(15*GetLevel(myHero)+15,10*GetLevel(myHero)+60)+.5*(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*(stagedmg2+stagedmg3)) Typedmg = 2 --stage1:Savagery. stage2-stage3:Empowered Savagery.
			elseif spellname == "W" then apdmg = math.max((30*Wlvl(myHero)+20+.8*GetBonusAP(myHero))*stagedmg1,(math.min(15*GetLevel(myHero)+25,math.max(145,10*GetLevel(myHero)+60))+.8*GetBonusAP(myHero))*(stagedmg2+stagedmg3)) --stage1:Battle Roar. stage2-stage3:Empowered Battle Roar.
		...
		elseif GetObjectName(myHero) == "Riven" then
			if spellname == "P" then addmg = 5+math.max(5*math.floor((GetLevel(myHero)+2)/3)+10,10*math.floor((GetLevel(myHero)+2)/3)-15)*(GetBonusdmg(myHero)+GetBaseDamage(myHero))/100 --xcharge
		...
		elseif GetObjectName(myHero) == "Rumble" then
			if spellname == "P" then apdmg = 20+5*GetLevel(myHero)+.25*GetBonusAP(myHero) Typedmg = 2 --xhit
		...
		elseif GetObjectName(myHero) == "Ryze" then
			if spellname == "Q" then apdmg = 25*Qlvl(myHero)+35+.55*GetBonusAP(myHero)+(0.05*Qlvl(myHero)+0.15)*GetMaxMana(myHero)
			elseif spellname == "W" then apdmg = 20*Wlvl(myHero)+60+.4*GetBonusAP(myHero)+.025*GetMaxMana(myHero)
			elseif spellname == "E" then apdmg = math.max(16*Elvl(myHero)+20+.2*GetBonusAP(myHero)+.02*GetMaxMana(myHero),(16*Elvl(myHero)+34+.3*GetBonusAP(myHero)+.02*GetMaxMana(myHero))*4*stagedmg3) --xbounce. stage3: Max damage = initial damage + 6 * 1/2 initial damage = 4 initial damage
			end
		...
		elseif GetObjectName(myHero) == "Shen" then
			if spellname == "P" then apdmg = 4+4*GetLevel(myHero)+(GetMaxHP(myHero)-(428+85*GetLevel(myHero)))*.1 Typedmg = 2 --(bonus)
		...
		elseif GetObjectName(myHero) == "Shyvana" then
			if spellname == "Q" then addmg = (.05*Qlvl(myHero)+.75)*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 --Second Strike
			elseif spellname == "W" then apdmg = 13*Wlvl(myHero)+7+.2*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) --xsec (3 sec + 4 extra sec)
		...
		elseif GetObjectName(myHero) == "Sivir" then
			...
			elseif spellname == "W" then addmg = (.05*Wlvl(myHero)+.45)*(GetBonusdmg(myHero)+GetBaseDamage(myHero))*stagedmg2 Typedmg = 2 --stage1:bonus to attack target. stage2: Bounce Damage
			end
		elseif GetObjectName(myHero) == "Skarner" then
			if spellname == "P" then apdmg = 5*GetLevel(myHero)+15 Typedmg = 2
		...
		elseif GetObjectName(myHero) == "Sona" then
			if spellname == "P" then apdmg = (math.max(7*GetLevel(myHero)+6,8*GetLevel(myHero)+3,9*GetLevel(myHero)-2,10*GetLevel(myHero)-8,15*GetLevel(myHero)-78)+.2*GetBonusAP(myHero))*(1+stagedmg1) Typedmg = 2 --stage1: Staccato. stage2:Diminuendo or Tempo
		...
		elseif GetObjectName(myHero) == "TahmKench" then
		    if spellname == "Q" then apdmg = 45*Qlvl(myHero)+35+.7*GetBonusAP(myHero)
			elseif spellname == "W" then apdmg = 50*Wlvl(myHero)+50+.6*GetBonusAP(myHero)
			end
		elseif GetObjectName(myHero) == "Talon" then
			if spellname == "Q" then addmg = 40*Qlvl(myHero)+1.3*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 --(bonus)
		...
		elseif GetObjectName(myHero) == "Taric" then
			if spellname == "P" then apdmg = .2*GetArmor(myHero) Typedmg = 2 --(bonus)
			elseif spellname == "W" then apdmg = 40*Wlvl(myHero)+.2*GetArmor(myHero)
			elseif spellname == "E" then apdmg = math.max(30*Elvl(myHero)+10+.2*GetBonusAP(myHero),(30*Elvl(myHero)+10+.2*GetBonusAP(myHero))*2*stagedmg3) --min (lower damage the farther the target is) up to 200%. stage3: Max damage
			elseif spellname == "R" then apdmg = 100*Rlvl(myHero)+50+.5*GetBonusAP(myHero)
			end
		...
		elseif GetObjectName(myHero) == "Tristana" then
			if spellname == "W" then apdmg = 25*Wlvl(myHero)+55+.5*GetBonusAP(myHero), (25*Wlvl(myHero)+55+.5*GetBonusAP(myHero))*2 --max damage, jumping onto max stack explosive charge
		...
		elseif GetObjectName(myHero) == "Trundle" then
			if spellname == "Q" then addmg = 20*Qlvl(myHero)+(5*Qlvl(myHero)+95)*(GetBonusdmg(myHero)+GetBaseDamage(myHero))/100 Typedmg = 2 --(bonus)
		...
		elseif GetObjectName(myHero) == "TwistedFate" then
			...
			elseif spellname == "W" then apdmg = math.max((7.5*Wlvl(myHero)+7.5+.5*GetBonusAP(myHero)+(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*stagedmg1,(15*Wlvl(myHero)+15+.5*GetBonusAP(myHero)+(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*stagedmg2,(20*Wlvl(myHero)+20+.5*GetBonusAP(myHero)+(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*stagedmg3) --stage1:Gold Card.  stage2:Red Card.  stage3:Blue Card
			elseif spellname == "E" then apdmg = 25*Elvl(myHero)+30+.5*GetBonusAP(myHero)
			end
		elseif GetObjectName(myHero) == "Twitch" then
			if spellname == "P" then dmg = math.floor((GetLevel(myHero)+3)/4 + 1) --xstack xsec (6 stack 6 sec)
		...
		elseif GetObjectName(myHero) == "Udyr" then
			if spellname == "Q" then addmg = math.max((50*Qlvl(myHero)-20+(.1*Qlvl(myHero)+1.1)*(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*(stagedmg2+stagedmg3),(.15*(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*stagedmg1) Typedmg = 2 --stage1:persistent effect. stage2:(bonus). stage3:stage2
			elseif spellname == "W" then Typedmg = 2
			elseif spellname == "E" then Typedmg = 2
			elseif spellname == "R" then apdmg = math.max((40*Rlvl(myHero)+.45*GetBonusAP(myHero))*stagedmg2,(10*Rlvl(myHero)+5+.25*GetBonusAP(myHero))*stagedmg3) Typedmg = 2 --stage1:0. stage2:xThird Attack. stage3:x wave (5 waves)
			end
		...
		elseif GetObjectName(myHero) == "Vayne" then
			if spellname == "Q" then addmg = (.05*Qlvl(myHero)+.25)*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 --(bonus)
		...
		elseif GetObjectName(myHero) == "Vi" then
			if spellname == "Q" then addmg = math.max(25*Qlvl(myHero)+25+.8*(GetBonusdmg(myHero)+GetBaseDamage(myHero)),(25*Qlvl(myHero)+25+.8*(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*2*stagedmg3) --x2 If charging up to 1.5 seconds. stage3: Max damage
			elseif spellname == "W" then addmg = ((3/2)*Wlvl(myHero)+5/2+(1/35)*(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*GetCurrentHP(target)/100
			elseif spellname == "E" then addmg = 15*Elvl(myHero)-10+.15*(GetBonusdmg(myHero)+GetBaseDamage(myHero))+.7*GetBonusAP(myHero) Typedmg = 2 --(Bonus)
		...
		elseif GetObjectName(myHero) == "Volibear" then
			if spellname == "Q" then addmg = 30*Qlvl(myHero) Typedmg = 2 --(bonus)
			...
			elseif spellname == "E" then apdmg = 45*Elvl(myHero)+15+.6*GetBonusAP(myHero)
			elseif spellname == "R" then apdmg = 80*Rlvl(myHero)-5+.3*GetBonusAP(myHero) Typedmg = 2 --xhit
			end
		...
		elseif GetObjectName(myHero) == "MonkeyKing" then
			if spellname == "Q" then addmg = 30*Qlvl(myHero)+.1*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 --(bonus)
		...
		elseif GetObjectName(myHero) == "XinZhao" then
			if spellname == "Q" then addmg = 15*Qlvl(myHero)+.2*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 --(bonus x hit)
		...
		elseif GetObjectName(myHero) == "Yasuo" then
			if spellname == "Q" then addmg = 20*Qlvl(myHero) Typedmg = 2 -- can critically strike, dealing X% ad
		...
		elseif GetObjectName(myHero) == "Yorick" then
			...
			elseif spellname == "Q" then addmg = 30*Qlvl(myHero)+.2*(GetBonusdmg(myHero)+GetBaseDamage(myHero)) Typedmg = 2 --(bonus)
		...
		elseif GetObjectName(myHero) == "Zed" then
			if spellname == "P" then apdmg = (6+2*(math.floor((GetLevel(myHero)-1)/6)))*GetMaxHP(target)/100 Typedmg = 2
			elseif spellname == "Q" then addmg = math.max((40*Qlvl(myHero)+35+(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*stagedmg1,(40*Qlvl(myHero)+35+(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*.6*stagedmg2,(40*Qlvl(myHero)+35+(GetBonusdmg(myHero)+GetBaseDamage(myHero)))*1.5*stagedmg3)  --stage1:multiple shurikens deal 50% damage. stage2:Secondary targets. stage3: Max damage
		...
		elseif GetObjectName(myHero) == "Ziggs" then
			if spellname == "P" then apdmg = math.max(4*GetLevel(myHero)+16,8*GetLevel(myHero)-8,12*GetLevel(myHero)-56)+(.2+.05*math.floor((GetLevel(myHero)+5)/6))*GetBonusAP(myHero) Typedmg = 2
			...
			elseif spellname == "E" then apdmg = 25*Elvl(myHero)+15+.3*GetBonusAP(myHero) --xmine , 40% damage from additional mines
...
function CalcDamage(source, target, addmg)
	...
	for i = 0,63 do
		...
		targetcurrbufname = GetBuffName(target,i);
		targetcurrbufcount = GetBuffCount(target,i);
		end
	end
	...
	if currbuffcount > 0 then
	   ...
	   return (1-0.45+0.05*GetCastLevel(_W)) * math.floor(addmg*(1-ArmorPercent))
	   elseif targetcurrbufname = "maokaidrain3defense" then
	   return 0.8 * math.floor(addmg*(1-ArmorPercent))
	   elseif targetcurrbufname = "katarinaereduction" then
	   return 0.85 * math.floor(addmg*(1-ArmorPercent))
	   elseif targetcurrbufname = "gragaswself" then
	   return (1-0.08+0.02*GetCastLevel(_W)) * math.floor(addmg*(1-ArmorPercent))
	   elseif targetcurrbufname = "GarenW" then
	   return 0.7 * math.floor(addmg*(1-ArmorPercent))
	   elseif targetcurrbufname = "FerociousHowl" then
	   return 0.3 * math.floor(addmg*(1-ArmorPercent))
...
function CalcDamage(source, target, apdmg)
	...
	if currbuffcount > 0 then
	   ...
	   elseif currbufname = "sonapassivedebuff" then
	   return 0.8 * math.floor(apdmg*(1-MagicArmorPercent))
	   elseif GetObjectName(target) == "Kassadin" then
	   return 0.85 * math.floor(apdmg*(1-MagicArmorPercent))
	   elseif targetcurrbufname = "vladimirhemoplaguedebuff" then
	   return 1.12 * math.floor(apdmg*(1-MagicArmorPercent))
	   elseif targetcurrbufname = "Meditate" then
	   return (1-0.45+0.05*GetCastLevel(_W)) * math.floor(apdmg*(1-MagicArmorPercent))
	   elseif targetcurrbufname = "maokaidrain3defense" then
	   return 0.8 * math.floor(apdmg*(1-MagicArmorPercent))
	   elseif targetcurrbufname = "katarinaereduction" then
	   return 0.85 * math.floor(apdmg*(1-MagicArmorPercent))
	   elseif targetcurrbufname = "gragaswself" then
	   return (1-0.08+0.02*GetCastLevel(_W)) * math.floor(apdmg*(1-MagicArmorPercent))
	   elseif targetcurrbufname = "GarenW" then
	   return 0.7 * math.floor(apdmg*(1-MagicArmorPercent))
	   elseif targetcurrbufname = "FerociousHowl" then
	   return 0.3 * math.floor(apdmg*(1-MagicArmorPercent))
	   end
	end
end
